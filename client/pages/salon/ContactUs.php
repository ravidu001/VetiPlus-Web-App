...
<head>
    ...
    <title>Profile </title>
    <link rel="stylesheet" href="../../assets/cssFiles/salon/sidebar.css" type="text/css">
    <link rel="stylesheet" href="../../../client/assets/cssFiles/salon/ContactUs.css" type="text/css">
...
<body>
    <div class="pagecontent">
        <div>
            <?php include '../../components/salon/sidebar.php'; ?>
        </div>
        <div>
            <section class="home">
